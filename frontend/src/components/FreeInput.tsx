  ...
  return (
    <div className="mt-2.5 sm:mt-3">
      ...
      <div className="flex items-center gap-1.5 mb-1.5">
        <MessageSquare size={12} className="text-primary-light/50" />
        <span className="text-[11px] text-primary-light/50 tracking-wide">自由发言</span>
      </div>
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full text-text-bright
                       bg-surface-light/40 backdrop-blur-sm
                       border border-primary/15 focus:border-primary/40
                       ...
                       shadow-[0_0_12px_rgba(168,130,255,0.04)]
                       focus:shadow-[0_0_16px_rgba(168,130,255,0.1)]"
          />
        </div>
